...
Suite *calc_suite(void) {
  ...
  tcase_add_test(tc_core, int_2);
  tcase_add_test(tc_core, int_3);
  tcase_add_test(tc_core, int_4);
  tcase_add_test(tc_core, int_er1);
  tcase_add_test(tc_core, int_er2);
